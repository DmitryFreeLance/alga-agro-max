...
public class BotUpdateHandler {
    ...
    private void sendWelcome(Long userId, boolean admin) {
        String text = """
                🌿 <b>Официальный бот ООО «АЛГА АГРО»</b>
                ...
                Вы можете:
                • открыть мини-приложение компании через системную кнопку MAX;
                • собрать корзину и отправить заказ;
                • быстро вернуться к подбору товаров по нужной культуре.

                Чтобы открыть каталог, воспользуйтесь кнопкой мини-приложения внизу слева.
                """;
